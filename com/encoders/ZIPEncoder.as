...
package com.encoders
{
	...
	import com.encoders.components.CRC32;
	...
	*/
	public class ZIPEncoder
	{
		...
		* </div>
		*/
		public function ZIPEncoder ( pCompression:String='GZIP' )
		{
		...
		*/	
		public function addFile ( pBytes:ByteArray, pDirectory:String ):void
		{
			...
			// File is deflated 
			feedArrayRow.writeShort ( this.compressionMethod == ZipCompression.GZIP ? 0x0008 : 0x0000 );
			...
			// If GZIP compression
			if ( compressionMethod == ZipCompression.GZIP ) 
			...
			addCentralRecord.writeShort ( 0x0000 );    
			addCentralRecord.writeShort ( this.compressionMethod == ZipCompression.GZIP ? 0x0008 : 0x0000 );    
		...
		*/	
		...
		public function saveZIP (): ByteArray
		{
