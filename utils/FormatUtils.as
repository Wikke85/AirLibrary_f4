package utils
{
	...
	{
		public static var DATABASE_DATE:String = 'yyyy/mm/dd hh:mi:ss';
		...
		public static function filesize(sizeInBytes:Number):String {
			...
			return sizeInBytes.toFixed(2) + ' ' + (['b', 'kB', 'MB', 'GB', 'TB'][index]);
		}
		...
		public static function bitrate(sizeInBits:Number, precision:int = 0):String {
			...
			return sizeInBits.toFixed(precision) + ' ' + (['bps', 'kbps', 'mbps', 'gbps', 'tbps'][index]);
		}
